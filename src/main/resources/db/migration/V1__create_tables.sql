...
create table orders (id int8 not null, count int4, date_closed timestamp, date_create timestamp, status varchar(255), total_price float8, client_id int8, discount_id int8, primary key (id));
